...
local function Update(self)
	...
	if
		...
		((powerType == 'RAGE' or powerType == 'RUNIC_POWER' or powerType == 'FURY') and power > 0) or
		((powerType ~= 'RAGE' and powerType ~= 'RUNIC_POWER' and powerType == 'FURY') and power < UnitPowerMax(unit) and not (addmax>0 and addcur==addmax)) or
		GetMouseFocus() == self
	then
