...
function CT:Initialize()
    ...
    self.frames = {}
    self.frames["outgoing"] = self:CreateMessageFrame("OutGoing", 150, 300, "RIGHT")
    self.frames["outgoing"]:SetPoint("BOTTOMRIGHT", "RayUF_TargetTarget", "TOPRIGHT", 0, 30)

    self.frames["healing"] = self:CreateMessageFrame("Healing", 110, 250, "LEFT")
    self.frames["healing"]:SetPoint("BOTTOMLEFT", "RayUF_Player", "TOPLEFT", -10, 80)

    self.frames["incoming"] = self:CreateMessageFrame("InComing", 110, 150, "LEFT")
    self.frames["incoming"]:SetPoint("TOPLEFT", "RayUI_CombatText_Healing", "TOPRIGHT", 5, 0)

    self.frames["message"] = self:CreateMessageFrame("Message", 256, 100, "CENTER")
    self.frames["message"]:SetPoint("BOTTOM", R.UIParent, "CENTER", 0, 280)
