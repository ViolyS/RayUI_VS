...
function UF:Construct_CombatIndicator(frame)
    local CombatIndicator = frame.RaisedElementParent:CreateTexture(nil, "OVERLAY")
    CombatIndicator:Size(20, 20)
    CombatIndicator:ClearAllPoints()
    CombatIndicator:Point("LEFT", frame, "LEFT", -10, -5)
    CombatIndicator:SetTexture("Interface\\AddOns\\RayUI\\media\\combat")
    CombatIndicator:SetVertexColor(0.6, 0, 0)
